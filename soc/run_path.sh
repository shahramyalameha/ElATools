...
!read(*,*)id 
     call system("clear")
 open (12,file='$current_directory/../db/All_2ID_cop.csv')
do  i=1,13122
   read(12,* )id2(i)
   if (id2(i)==id )then
...
enddo
 ...
 i=0
 open (11,file='$current_directory/../db/Cijs.binery')
do  i=1,2043900
...
SUBROUTINE swin_web(namepro)
 ...
 WRITE(66,"(a)")'<html><link type="text/css" rel="stylesheet" id="dark-mode-custom-link">'
  CALL system("cp $current_directory/../db/plotly.js .")
