...
SUBROUTINE set_nplot_agr(Nploter,colora,label_dat)
   IMPLICIT  NONE
        INTEGER :: Nploter
        INTEGER, DIMENSION(6)::colora
        ChARACTER(30)     :: label_dat
     ...
     WRITE(2,'(a,I1,3a)') '@  s',Nploter,' legend "', label_dat,'"'
END SUBROUTINE
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
SUBROUTINE set_nplot_velocity_agr(Nploter,colora,label_dat)
   IMPLICIT  NONE
        INTEGER               :: Nploter
        INTEGER, DIMENSION(6) :: colora
        ChARACTER(30)         :: label_dat
