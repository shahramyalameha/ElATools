...
!read(*,*)id 
     call system("clear")
 open (12,file='/home/shahram/Desktop/Cubelast/code/programMY/AAEP/soc/eatools_v1.7.0/db/All_2ID_cop.csv')
do  i=1,13122
   read(12,* )id2(i)
   if (id2(i)==id )then
...
enddo
 ...
 i=0
 open (11,file='/home/shahram/Desktop/Cubelast/code/programMY/AAEP/soc/eatools_v1.7.0/db/Cijs.binery')
do  i=1,2043900
